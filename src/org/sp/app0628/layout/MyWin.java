/*
 * java.awt 패키지는 os마다 디자인이 틀려지는 문제발생 
 * 따라서 디자인을 모든 OS종류와 상관없이 자바에서 지정한 디자인테마로 고정하기 위해 Swing이
 * 개발 되었고, javax.swing 패키지에서 지원됨.. 스윙은 기존의 awt 객체명에 접두어로 J를 붙임
 * 
...
public class MyWin extends JFrame{
	...
	public MyWin() {
		...
		setSize(300, 400);
		setVisible(true);
		//윈도우창을 닫으면 setVisible(false)가 될 뿐이므로, 실제 프로그램인 즉 프로세스는 여전히
